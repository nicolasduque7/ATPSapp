  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex flex-wrap items-center justify-between gap-4">
        ...
        <AddClassButton coachId={coach.id} students={students} locations={locations} />
      </div>

      <NextClassCard nextClass={nextClass} currentCoachId={coach.id} students={students} locations={locations} />
